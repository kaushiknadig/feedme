...
public class SQLiteHandlerStudent extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_LOGIN_TABLE = "CREATE TABLE " + TABLE_USER + "("
                + KEY_ID + " INTEGER PRIMARY KEY," + KEY_USN + " TEXT,"
                + KEY_NAME + " TEXT,"
                + KEY_EMAIL + " TEXT UNIQUE," + KEY_SEM + " TEXT,"
                + KEY_BRANCH + " TEXT," + KEY_SECTION + " TEXT,"
                + KEY_UID + " TEXT,"
                + KEY_CREATED_AT + " TEXT" + ")";
     ...
     * */
    public void addUser(String usn, String name, String email, String sem, String branch, String section, String uid, String created_at) {
        ...
        values.put(KEY_EMAIL, sem);//sem
        values.put(KEY_BRANCH, branch);// Branch
        values.put(KEY_EMAIL, section);//section
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        if (cursor.getCount() > 0) {
            ...
            user.put("sem", cursor.getString(4));
            user.put("branch", cursor.getString(5));
