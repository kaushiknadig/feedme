...
public class LoginActivityStudent extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            ...
            Intent intent = new Intent(LoginActivityStudent.this, MainActivityStudent.class);
    ...
    private void checkLogin(final String email, final String password) {
        ...
        StringRequest strReq = new StringRequest(Method.POST,
                AppConfigStudent.URL_LOGIN, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(usn, name, email, sem, branch, section, uid, created_at);

                        // Launch main activity
                        Intent intent = new Intent(LoginActivityStudent.this,
